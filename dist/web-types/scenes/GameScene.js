...
import { WORLD_WIDTH, GAME_HEIGHT, COLORS, BASE_SCROLL_SPEED, MAX_SCROLL_SPEED, SPEED_ACCEL_RATE, PX_PER_METER, GATE_PASS_BONUS, AIR_TIME_DIVISOR, } from '@/data/constants';
...
export class GameScene extends Phaser.Scene {
    ...
    update(_time, delta) {
        ...
        // --- Chunks + collision ---
        const collision = this.chunkManager.update(this.worldOffsetY, this.player.x, this.player.screenY, this.player.state === PlayerState.Jumping);
        ...
        const yetiEvent = this.yetiSystem.update(this.distancePx, this.player.x, this.player.screenY, delta, yetiEnabled);
        if (yetiEvent === 'caught') {
